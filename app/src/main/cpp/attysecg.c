...
JNIEXPORT void JNICALL Java_tech_glasgowneuro_attysecg_HRVOculus_onSurfaceCreated(
    JNIEnv* env,
    jobject obj,
    jlong handle,
    jobject surface) {
...
JNIEXPORT void JNICALL Java_tech_glasgowneuro_attysecg_HRVOculus_onSurfaceChanged(
    JNIEnv* env,
    jobject obj,
    jlong handle,
    jobject surface) {
...
JNIEXPORT void JNICALL Java_tech_glasgowneuro_attysecg_HRVOculus_onSurfaceDestroyed(
    JNIEnv* env,
    jobject obj,
    jlong handle) {
